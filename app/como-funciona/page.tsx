...
export const metadata: Metadata = {
  ...
  description:
    "Asi desarrollamos tu aplicacion con inteligencia artificial: consulta gratuita, prototipo en 5 dias, desarrollo agil y despliegue en produccion. De tu idea a una app con IA en 2-12 semanas desde 899 €.",
}
