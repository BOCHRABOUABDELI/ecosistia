...
export const apps: AppItem[] = [
  {
    ...
    allIntegrations: ["OCR Avanzado", "Machine Learning", "ERP y sistemas de gestión interna de la institución", "Procesamiento de Lenguaje Natural", "Almacenamiento en la nube (S3, Azure, Google Cloud, etc.)", "Sistemas de autenticación corporativa (LDAP, SSO, etc.)", "Document AI"],
    seoContent: {
      ...
      paragraphs: [
        ...
        "Ecosistia ha desarrollado este software de digitalizacion documental para instituciones que gestionan miles o millones de documentos fisicos. El resultado es un archivo digital accesible, organizado y consultable en segundos, con exportacion a formatos estandar de archivistica como EAD, Dublin Core y METS. Todo por un precio cerrado de 899 €, con entrega del prototipo funcional en 5 dias.",
