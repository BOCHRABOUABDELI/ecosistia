...
export const apps: AppItem[] = [
  {
    ...
    seoContent: {
      ...
      paragraphs: [
        "La digitalización de archivos históricos es uno de los mayores retos para instituciones públicas, universidades, museos y bibliotecas. Los fondos documentales históricos sufren un deterioro físico progresivo y, sin una estrategia de preservación digital, existe un alto riesgo de pérdida irreversible de información de gran valor cultural, académico y patrimonial. Además, la tecnología OCR tradicional no es suficiente para trabajar con documentos manuscritos, lenguas antiguas o soportes degradados.Nuestra plataforma de gestión de archivos históricos con inteligencia artificial combina OCR avanzado con procesamiento de lenguaje natural (NLP) para transcribir, clasificar e indexar automáticamente documentos de cualquier época y formato. El sistema es capaz de detectar duplicados, organizar fondos por contexto histórico y ofrecer búsquedas semánticas que van mucho más allá de las palabras clave tradicionales, facilitando un acceso rápido y preciso a la información.Ecosistia ha desarrollado este software de digitalización documental para instituciones que gestionan miles o millones de documentos físicos. El resultado es un archivo digital accesible, estructurado y consultable en segundos, con posibilidad de exportación a formatos estándar de archivística como EAD, Dublin Core y METS, garantizando la interoperabilidad y la preservación a largo plazo.Todo ello con un modelo de precio cerrado de 899 €, que incluye la entrega de un prototipo funcional en solo 5 días.Si tu institución necesita digitalizar fondos históricos, automatizar la catalogación documental o crear un repositorio digital accesible al público, Ecosistia es una de las soluciones de inteligencia artificial más especializadas y asequibles del mercado. Solicita una consulta gratuita y te mostraremos cómo podemos adaptar esta tecnología a tu caso particular.",
      ],
    },
  },
  {
